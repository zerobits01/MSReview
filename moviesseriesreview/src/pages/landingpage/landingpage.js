...
const LandingPage = () => {
    const [state, dispatchData] = useState({});


    const redirectHome = (event) => {
        dispatchData({ get_started: true });
    }
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                            <button type="button" className="btn btn-block btn-lg btn-burly" onClick={redirectHome}>Get started!</button>
                        </div>
                    </div>
                </div>
            </header>
                        ...
                        <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                            <div className="form-row">
                                <div className="btn btn-block">
                                    <button type="submit" className="btn btn-block btn-lg" onClick={redirectSignUp} style={{ color: "burlywood", borderColor: 'burlywood' }}>Sign up!</button>
                                </div>
                            </div>
                        </div>
                    </div>
